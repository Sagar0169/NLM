...
const val MILK_UNION_ADD = "NationalDairyDevelopment/milkUnionAddEdit"
...
//NDD
    ...
    @POST(MILK_UNION_ADD)
    suspend fun getMilkUnionAdd(@Body request: MilkUnionAddRequest): Response<MilkUnionAddResponse>
