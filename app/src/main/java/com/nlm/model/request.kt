...
data class AddStateCenterLabRequest(
    val chemical_test_acid_profile_frequency: String?=null,
    val chemical_test_acid_profile_result: Int?=null,
    val chemical_test_aflatoxins_frequency: String?=null,
    val chemical_test_aflatoxins_result: Int?=null,
    val chemical_test_antibiotic_frequency: String?=null,
    val chemical_test_antibiotic_result: Int?=null,
    val chemical_test_metal_frequency: String?=null,
    val chemical_test_metal_result: Int?=null,
    val chemical_test_microbiological_frequency: String?=null,
    val chemical_test_microbiological_result: Int?=null,
    val chemical_test_others_frequency: String?=null,
    val chemical_test_others_result: Int?=null,
    val chemical_test_pesticide_frequency: String?=null,
    val chemical_test_pesticide_result: Int?=null,
    val chemical_test_protein_frequency: String?=null,
    val chemical_test_protein_result: Int?=null,
    val comments_of_nlm: String?=null,
    val created_by: Int?=null,
    val districts: Int?=null,
    val equipments_bacterial_avail_site: Int?=null,
    val equipments_bacterial_month_install: String?=null,
    val equipments_bacterial_status: Int?=null,
    val equipments_civil_work_avail_site: Int?=null,
    val equipments_civil_work_month_install: String?=null,
    val equipments_civil_work_status: Int?=null,
    val equipments_ftir_avail_site: Int?=null,
    val equipments_ftir_month_install: String?=null,
    val equipments_ftir_status: Int?=null,
    val equipments_gcms_avail_site: Int?=null,
    val equipments_gcms_month_install: String?=null,
    val equipments_gcms_status: Int?=null,
    val equipments_induced_couple_avail_site: Int?=null,
    val equipments_induced_couple_month_install: String?=null,
    val equipments_induced_couple_status: Int?=null,
    val equipments_lcms_avail_site: Int?=null,
    val equipments_lcms_month_install: String?=null,
    val nabl_certified_date: String?=null,
    val equipments_lcms_status: Int?=null,
    val financial_viability_cost_loss: String?=null,
    val financial_viability_cost_profit: String?=null,
    val future_plans: String?=null,
    val id: Int?=null,
    val is_deleted: Int?=null,
    val is_type: String?=null,
    val location_state_central_lab: String?=null,
    val nabl_certified: String?=null,
    val role_id: Int?=null,
    val skill_emp_details_no: List<String>?=null,
    val skill_emp_details_qualification: List<String>?=null,
    val state_central_lab_visit_document: List<ImplementingAgencyDocument>?=null,
    val state_code: Int?=null,
    val status: Int?=null,
    val is_draft: Int?=null,
    val lat_nlm: Double?=null,
...
data class AddMilkProcessingRequest(
    val addition_new_products: Int?=null,
    val any_other: String?=null,
    val asset_earmarked_remarks: String?=null,
    val asset_earmarked_under: Int?=null,
    val date_of_inspection: String?=null,
    val district_code: Int?=null,
    val has_new_plant: Int?=null,
    val has_new_plant_remarks: String?=null,
    val id: Int?=null,
    val increase_operational: Int?=null,
    val increase_sales: Int?=null,
    val is_draft: Int?=null,
    val lat_dcs: String?=null,
    val lat_processing_plant: Double?=null,
    val long_processing_plant: Double?=null,
    val long_dcs: String?=null,
    val name_processing_plant: String?=null,
    val name_milk_union: String?=null,
    val name_revenue_village: String?=null,
    val name_of_tehsil: String?=null,
    val overall_hygiene: Int?=null,
    val overall_hygiene_remarks: String?=null,
    val overall_upkeep_asset: Int?=null,
    val overall_upkeep_asset_remarks: String?=null,
    val processing_capacity_milk: Int?=null,
    val processing_capacity_productivity: Int?=null,
    val role_id: Int?=null,
    ...
    val user_id: String?=null,
    val is_type: String?=null,
    val whether_there: Int?=null,
    val whether_there_remarks: String?=null
)


data class AddMilkProductMarketingRequest(
    val any_other: String?=null,
    val asset_earmarked_project: Int?=null,
    val asset_earmarked_project_remarks: String?=null,
    val better_availability_milk: Int?=null,
    val created_by: Int?=null,
    val date_inspection: String?=null,
    val district_code: Int?=null,
    val id: Int?=null,
    val improvement_shelf_life_milk: Int?=null,
    val improvement_visibility: Int?=null,
    val increase_milk: Int?=null,
    val is_deleted: Int?=null,
    val is_draft: Int?=null,
    val is_type: String?=null,
    val lat_of_milk_parlour: String?=null,
    val long_of_milk_parlour: String?=null,
    val milk_product_marketing_document: List<ImplementingAgencyDocument>?=null,
    val name_milk_union: String?=null,
    val name_retail_shop: String?=null,
    val name_tehsil: String?=null,
    val overall_hygiene: Int?=null,
    val overall_hygiene_remarks: String?=null,
    val overall_upkeep: Int?=null,
    val overall_upkeep_remarks: String?=null,
    val provided_used_branding: Int?=null,
    val provided_used_branding_remarks: String?=null,
    val role_id: Int?=null,
    val selection_retailer: Int?=null,
    val selection_retailer_remarks: String?=null,
    val state_code: Int?=null,
    val status: Int?=null,
    val lat_nlm: Double?=null,
    val long_nlm: Double?=null,
...
data class MilkUnionAddRequest(
    val buffalo_milk_current_year_incentives: Int?=null,
    val buffalo_milk_last_year_incentives: Int?=null,
    val capacity_of_milk_chillers: Int?=null,
    val cow_milk_current_year_incentives: Int?=null,
    val cow_milk_last_year_incentives: Int?=null,
    val created_by: Int?=null,
    val current_month_avg_milk: Int?=null,
    val current_year_avg_milk: Int?=null,
    val current_year_buffalo_milk_price: Int?=null,
    val current_year_cow_milk_price: Int?=null,
    val daily_bulk_sale_to_other: String?=null,
    val daily_liquid_milk_sale: String?=null,
    val daily_value_added_product: String?=null,
    val districts_covered: String?=null,
    val future_plan_action: String?=null,
    val id: Int?=null,
    val is_deleted: Int?=null,
    val is_type: String?=null,
    val last_fy_cumulative_profit_loss: String?=null,
    val last_fy_net_profit_loss: String?=null,
    val last_fy_turnover: String?=null,
    val last_year_avg_milk: Int?=null,
    val last_year_buffalo_milk_price: Int?=null,
    val last_year_cow_milk_price: Int?=null,
    val milk_processing_plant_capacity: String?=null,
    val milk_processing_plant_location: String?=null,
    val milk_processing_plant_total: Int?=null,
    val milk_union_visit_report_document: List<ImplementingAgencyDocument>?=null,
    val name_of_milk_union: String?=null,
    val lat_nlm: Double?=null,
    val long_nlm: Double?=null,
    val no_of_dairy_functional: Int?=null,
    val no_of_dairy_organised: Int?=null,
    val no_of_milk_chillers: Int?=null,
    val no_of_milk_producers_enr: Int?=null,
    val no_of_villages: Int?=null,
    val no_of_villages_covered: Int?=null,
    val photographs_of_site: String?=null,
    val remarks_by_nlm: String?=null,
    val role_id: Int?=null,
    val staff_available: String?=null,
    val staff_sanctioned: String?=null,
    val state_code: Int?=null,
    val status: Int?=null,
    val is_draft: Int?=null,
    val user_id: String?=null,
