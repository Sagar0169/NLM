...
public class Preferences {
    ...
    public static Result getPreferenceOfScheme(Context context, String key, Class<Result> typeClass) {
        Gson gson = new Gson();
        SharedPreferences prefs = Preferences.getSharedPreferences(context);
        prefs.getString(key, "");
        return gson.fromJson(prefs.getString(key, ""), typeClass);
...
//
//    public static LocationDetailsUserData getPreferenceOfLocationData(Context context, String key, Class<LocationDetailsUserData> typeClass) {
//        Gson gson = new Gson();
//        SharedPreferences prefs = Preferences.getSharedPreferences(context);
//        prefs.getString(key, "");
//        return gson.fromJson(prefs.getString(key, ""), typeClass);
...
//
//
//    public static UserExtraExperienceDetail getPreferenceOfExperienceData(Context context, String key, Class<UserExtraExperienceDetail> typeClass) {
//        Gson gson = new Gson();
//        SharedPreferences prefs = Preferences.getSharedPreferences(context);
//        prefs.getString(key, "");
//        return gson.fromJson(prefs.getString(key, ""), typeClass);
//    }
//
//    public static OtherDetail getPreferenceOfOtherDetailsData(Context context, String key, Class<OtherDetail> typeClass) {
//        Gson gson = new Gson();
//        SharedPreferences prefs = Preferences.getSharedPreferences(context);
//        prefs.getString(key, "");
//        return gson.fromJson(prefs.getString(key, ""), typeClass);
//    }
//
//    public static MedicalAssessment getPreferenceOfMedicalAssessmentData(Context context, String key, Class<MedicalAssessment> typeClass) {
//        Gson gson = new Gson();
//        SharedPreferences prefs = Preferences.getSharedPreferences(context);
//        prefs.getString(key, "");
//        return gson.fromJson(prefs.getString(key, ""), typeClass);
//    }
//
//    public static TFNAndUsiNumber getPreferenceOfTfnAndUsiNumberData(Context context, String key, Class<TFNAndUsiNumber> typeClass) {
//        Gson gson = new Gson();
//        SharedPreferences prefs = Preferences.getSharedPreferences(context);
//        prefs.getString(key, "");
//        return gson.fromJson(prefs.getString(key, ""), typeClass);
//    }
//
//    public static Visa getPreferenceOfVisaData(Context context, String key, Class<Visa> typeClass) {
//        Gson gson = new Gson();
//        SharedPreferences prefs = Preferences.getSharedPreferences(context);
//        prefs.getString(key, "");
//        return gson.fromJson(prefs.getString(key, ""), typeClass);
//    }
//
//    public static AddPassportDetailsRequest getPreferenceOfPassportData(Context context, String key, Class<AddPassportDetailsRequest> typeClass) {
//        Gson gson = new Gson();
//        SharedPreferences prefs = Preferences.getSharedPreferences(context);
//        prefs.getString(key, "");
//        return gson.fromJson(prefs.getString(key, ""), typeClass);
//    }
//
//    public static AddDrivingLicenseDetailsRequest getPreferenceOfDrivingLicenseData(Context context, String key, Class<AddDrivingLicenseDetailsRequest> typeClass) {
//        Gson gson = new Gson();
//        SharedPreferences prefs = Preferences.getSharedPreferences(context);
//        prefs.getString(key, "");
//        return gson.fromJson(prefs.getString(key, ""), typeClass);
//    }
//
//    public static AddProofOfAgeDetailsRequest getPreferenceOfProofOfAgeData(Context context, String key, Class<AddProofOfAgeDetailsRequest> typeClass) {
//        Gson gson = new Gson();
//        SharedPreferences prefs = Preferences.getSharedPreferences(context);
//        prefs.getString(key, "");
//        return gson.fromJson(prefs.getString(key, ""), typeClass);
//    }
//
//    public static FilterListResponse getPreferenceOfFilterData(Context context, String key, Class<FilterListResponse> typeClass) {
//        Gson gson = new Gson();
//        SharedPreferences prefs = Preferences.getSharedPreferences(context);
//        prefs.getString(key, "");
//        return gson.fromJson(prefs.getString(key, ""), typeClass);
