...
class SemenStationManpowerFragment(
    private val viewEdit: String?,
    private val itemId: Int?,
    private val dId: Int?
) : BaseFragment<FragmentSemenStationManpowerBinding>(), CallBackDeleteFSPAtId, CallBackBreedAvg,
    ...
    override fun init() {
        ...
        mBinding?.tvDate?.setOnClickListener {
            openCalendar("tvDate", mBinding?.tvDate!!)
        }
        ...
        mBinding?.rgRemarksOfNlm?.setOnCheckedChangeListener { group, checkedId ->
            remarkRadio = when (checkedId) {
                R.id.rbCooperation -> {
                    mBinding?.tvAvailability?.showView()
                    mBinding?.rgComputer?.showView()
                    mBinding?.tvState2?.showView()
                    mBinding?.llBreedWise?.showView()
                    mBinding?.llSupportDocumentNlm?.showView()
                    1
                }
                R.id.rbNonCoorperation -> {
                    mBinding?.tvAvailability?.hideView()
                    mBinding?.rgComputer?.hideView()
                    mBinding?.tvState2?.hideView()
                    mBinding?.llBreedWise?.hideView()
        ...
        if (viewEdit == "view") {
            ...
            mBinding?.rgIsoYes?.isEnabled = false
            mBinding?.rgIsoNo?.isEnabled = false
            mBinding?.rbA?.isEnabled = false
            mBinding?.rbB?.isEnabled = false
            mBinding?.rbComputerYes?.isEnabled = false
            mBinding?.rbComputerNo?.isEnabled = false
            mBinding?.et23JerProduced?.isEnabled = false
            mBinding?.et23JerSold?.isEnabled = false
            mBinding?.et24JerProduced?.isEnabled = false
            mBinding?.et24JerSold?.isEnabled = false
            mBinding?.et25JerProduced?.isEnabled = false
            mBinding?.et25JerSold?.isEnabled = false
            mBinding?.et26JerProduced?.isEnabled = false
            mBinding?.et26JerSold?.isEnabled = false
            mBinding?.et23CrossProduced?.isEnabled = false
            mBinding?.et23CrossSold?.isEnabled = false
            mBinding?.et24CrossProduced?.isEnabled = false
            mBinding?.et24CrossSold?.isEnabled = false
            mBinding?.et25CrossProduced?.isEnabled = false
            mBinding?.et25CrossSold?.isEnabled = false
            mBinding?.et26CrossSold?.isEnabled = false
            mBinding?.et23IndiProduced?.isEnabled = false
            mBinding?.et23IndiSold?.isEnabled = false
            mBinding?.et24IndiProduced?.isEnabled = false
            mBinding?.et24IndiSold?.isEnabled = false
            mBinding?.et25IndiProduced?.isEnabled = false
            mBinding?.et25IndiSold?.isEnabled = false
            mBinding?.et26IndiProduced?.isEnabled = false
            mBinding?.et26IndiSold?.isEnabled = false
            mBinding?.et23MurrahProduced?.isEnabled = false
            mBinding?.et23MurrahSold?.isEnabled = false
            mBinding?.et24MurrahProduced?.isEnabled = false
            mBinding?.et24MurrahSold?.isEnabled = false
            mBinding?.et25MurrahProduced?.isEnabled = false
            mBinding?.et25MurrahSold?.isEnabled = false
            mBinding?.et26MurrahProduced?.isEnabled = false
            mBinding?.et26MurrahSold?.isEnabled = false
            mBinding?.etWHetherBulls?.isEnabled = false
            mBinding?.etYearCommencement?.isEnabled = false
            mBinding?.tvBreedWise?.isEnabled = false
            mBinding?.etJerseyBreed?.isEnabled = false
            mBinding?.etCrossbredsBreed?.isEnabled = false
            mBinding?.etInddigenousBreed?.isEnabled = false
            mBinding?.etMurrahBreed?.isEnabled = false
            mBinding?.etCommentsOfNLM?.isEnabled = false
            mBinding?.tvAddMore2?.isEnabled = false
            mBinding?.tvBreedWise?.hideView()
    ...
    private fun rspBuckAdapter() {
        ...
        addBuckAdapter =
            RspBreedWiseAdapter(requireContext(), addBucksList, viewEdit, this, this)
        mBinding?.rvBreedWise?.adapter = addBuckAdapter
        mBinding?.rvBreedWise?.layoutManager =
