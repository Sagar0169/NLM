...
class EdpIAAdapter(
...
) : RecyclerView.Adapter<EdpIAAdapter.AvailabilityOfEquipmentViewHolder>() {



    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): AvailabilityOfEquipmentViewHolder {

        val binding = ItemNlmedpIaBinding.inflate(
    ...
    inner class AvailabilityOfEquipmentViewHolder(val binding: ItemNlmedpIaBinding) :
