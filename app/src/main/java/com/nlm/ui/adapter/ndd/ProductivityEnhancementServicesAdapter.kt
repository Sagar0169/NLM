...
class ProductivityEnhancementServicesAdapter(
    ...
    private val implementingAgencyList: ArrayList<NDDProductivityEnhancementServicesListData>,
    ...
    class Viewholder(val mBinding: ItemProductivityEnhancementServicesBinding) :
