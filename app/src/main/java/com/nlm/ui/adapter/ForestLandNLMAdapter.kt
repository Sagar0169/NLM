...
class ForestLandNLMAdapter(
    ...
    override fun onBindViewHolder(holder: AvailabilityOfEquipmentViewHolder, position: Int) {
        ...
        holder.binding.tvDistrictNlm.setOnClickListener { showBottomSheetDialog("projectFinancing",holder.binding.tvDistrictNlm) }
        holder.binding.tvAgencyInvolved.setOnClickListener { showBottomSheetDialog("Animals",holder.binding.tvAgencyInvolved) }
        // Add new row
