...
class MobileVeterinaryAdapter(
    ...
    class MobileVeterinaryAdapterViewHolder(val mBinding: ItemVaccinationProgrammerBinding) : RecyclerView.ViewHolder(mBinding.root)
    ...
    override fun onBindViewHolder(holder: MobileVeterinaryAdapterViewHolder, @SuppressLint("RecyclerView") position: Int) {
