...
class AscadAdapter(
    ...
    class AscadAdapterViewHolder(val mBinding: ItemVaccinationProgrammerBinding) : RecyclerView.ViewHolder(mBinding.root)
    ...
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): AscadAdapterViewHolder {
        val mBinding = ItemVaccinationProgrammerBinding.inflate(
            LayoutInflater.from(parent.context), parent, false
        )
        return AscadAdapterViewHolder(mBinding)
    }

    // Bind the data to the views in each item
    override fun onBindViewHolder(holder: AscadAdapterViewHolder, @SuppressLint("RecyclerView") position: Int) {
