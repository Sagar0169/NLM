...
class AgencyWiseAIAdapterRGM(
    private val context: Context,
    private val RGMAgencyWiseCalfList: MutableList<RgmImplementingAgencyAgencyWiseAiDone>,
    private val viewEdit: String?,
    private val callBackEdit: CallBackItemTypeRGMStateIAAgencyWiseAi,
    private val callBackDeleteAtId: CallBackDeleteAtId,
) : RecyclerView.Adapter<AgencyWiseAIAdapterRGM.AvailabilityOfEquipmentViewHolder>() {
