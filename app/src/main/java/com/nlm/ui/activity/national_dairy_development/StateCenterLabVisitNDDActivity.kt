...
class StateCenterLabVisitNDDActivity : BaseActivity<ActivityStateCenterLabVisitNddBinding>(),
    ...
    override fun initView() {
        ...
        mBinding!!.fabAdd.setOnClickListener {
            val intent = Intent(
                ...
                AddStateCenterLabtVisit::class.java
            ).putExtra("isFrom", 1)
    ...
    override fun setObservers() {
        viewModel.stateCenterLabListResult.observe(this) {
...
//                    implementingAgencyAPICall(paginate = true, loader = true)
    ...
    private fun implementingAgency() {
        nlmComponentBAdapter = StateCenterLabVisitAdapter(this, nlmComponentBList, this)
    ...
    private fun componentBListApiCall(
        ...
        viewModel.getStateCenterLabList(
            this, loader, NDDStateCenterLabListRequest(
