...
import com.nlm.model.NDDProductivityEnhancementServicesListData
...
class ProductivityEnhancementServicesNDDActivity : BaseActivity<ActivityProductivityEnhancementServicesNddBinding>(),
    ...
    override fun setObservers() {
        viewModel.productivityEnchancementServicesListResult.observe(this) {
    ...
    private fun implementingAgency() {
        nlmComponentBAdapter = ProductivityEnhancementServicesAdapter(this,nlmComponentBList,this)
    ...
    private fun componentBListApiCall(paginate: Boolean, loader: Boolean,district:Int,phone:String,year:String) {
        ...
        viewModel.getProductivityEnhancementServicesList(
            this, loader, NDDProductivityEnhancementServicesListRequest(
