            ...
            if (userResponseModel != null) {
                if (userResponseModel._resultflag == 0) {
                    ...
                    if (savedAsDraft) {
                        ...
                        mBinding?.etInputOne?.setText(userResponseModel._result.mechanisim_followed_inputs)
                        mBinding?.etRemarkOne?.setText(userResponseModel._result.mechanisim_followed_remarks)
                        mBinding?.etInputTwo?.setText(userResponseModel._result.trained_staff_engaged_inputs)
                        mBinding?.etRemarkTwo?.setText(userResponseModel._result.trained_staff_engaged_remarks)
                        mBinding?.etInputThree?.setText(userResponseModel._result.mass_education_campaign_inputs)
                        mBinding?.etRemarkThree?.setText(userResponseModel._result.mass_education_campaign_remarks)
                        mBinding?.etInputFour?.setText(userResponseModel._result.are_functionaries_aware_inputs)
