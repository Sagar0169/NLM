...
class DairyPlantVisitNDDActivity : BaseActivity<ActivityDairyPlantVisitNddBinding>(),
    ...
    override fun setObservers() {
        viewModel.dairyPlantListResult.observe(this) {
    ...
    private fun implementingAgency() {
        nlmComponentBAdapter = DairyPlantVisitAdapter(this,nlmComponentBList,this)
    ...
    private fun componentBListApiCall(paginate: Boolean, loader: Boolean,district:Int,phone:String,year:String) {
        ...
        viewModel.getDairyPlantList(
            this, loader, NDDDairyPlantListRequest(
