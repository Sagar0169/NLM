...
import com.nlm.ui.fragment.TrainingCenterIAFragment
import com.nlm.ui.fragment.TrainingCenterNLMFragment
...
class AddTrainingCenters : BaseActivity<ActivityAddTrainingCentersBinding>() {
    ...
    override fun initView() {
        ...
        setupTabLayout()
        loadFragment(TrainingCenterIAFragment(viewEdit, itemId, dId))
    }
            ...
            addOnTabSelectedListener(object : TabLayout.OnTabSelectedListener {
                override fun onTabSelected(tab: TabLayout.Tab?) {
                    when (tab?.position) {
                        ...
                        1 -> {
                            onTabClicks()
                            loadFragment(TrainingCenterNLMFragment(viewEdit, itemId, dId))
