...
class MilkProductMarketingNDDActivity : BaseActivity<ActivityMilkProductMarketingNddBinding>(),
    ...
    override fun setObservers() {
        viewModel.milkProductMarketingListResult.observe(this) {
    ...
    private fun implementingAgency() {
        nlmComponentBAdapter = MilkProductMarketingAdapter(this,nlmComponentBList,this)
    ...
    private fun componentBListApiCall(paginate: Boolean, loader: Boolean,district:Int,phone:String,year:String) {
        ...
        viewModel.getMilkProductMarketingList(
            this, loader, NDDMilkProductMarketingListRequest(
