...
import mission.vatsalya.ui.adapter.ChooseFileAdapter
import mission.vatsalya.ui.fragment.LocationDetailsFragment.OnNextButtonClickListener
...
class UploadMediaFragment : BaseFragment<FragmentUploadMediaBinding>(),ChooseFileAdapter.OnFileSelectListener{
    ...
    override fun init() {
        ...
        adapter = ChooseFileAdapter(items,"Photos",this)
        adapter2 = ChooseFileAdapter(items2,"Video",this)
